        ...
        <div class="card">
            <div class="card-header p-0">
                ...
                <div class="px-2 mt-4">
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                        @if(getCrudConfig('Region')->create && hasPermission(getRouteName().'.region.create', 1, 0))
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            <th scope="col" style='cursor: pointer' wire:click="sort('des_region')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'des_region') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'des_region') fa-sort-amount-up ml-2 @endif'></i> {{ __('Región') }} </th>
