...
<template>
    ...
    <div class="container">
        <div class="flex-row">
            ...
            <h2 class="blockquote mb-0"> <mark>Bienvenido a Libreria El Gran Poeta</mark> </h2>
            <br>
            <p class="blockquote mb-0">Inicia sesión o Regístrese </p>
        </div>
        <div class="flex-row">
            <AuthenticationCard>
                <form @submit.prevent="submit">
                    ...
                    <div class="flex items-center justify-end mt-4">
                        <Link :href="route('login')"
                            class="underline text-sm text-gray-600  rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
